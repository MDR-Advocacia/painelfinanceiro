...
interface AppState {
  ...
  periodoAtivo: string;
  view: 'dashboard' | 'setor' | 'projecoes' | 'ranking' | 'sede' | 'honorarios' | 'config-estrategica' | 'pessoal' | 'estrutura' | 'estrutura-centro' | 'estrutura-equipe' | 'estrutura-sede' | 'estrutura-admin' | 'arquivo-contabil';
  viewMode: ViewMode;
}
